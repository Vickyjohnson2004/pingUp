    ...
    >
      ...
      <div className="flex mt-4 gap-2">
        ...
        <button
          ...
          className="flex items-center justify-center w-16 py-2 rounded-md border border-gray-300 hover:bg-gray-100 active:scale-95 transition text-slate-500 cursor-pointer group"
        >
