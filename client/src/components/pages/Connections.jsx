      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8 flex flex-wrap gap-6">
          {dataArray.map((tab, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-center gap-1 border h-20 w-40 border-gray-200 bg-white rounded-md shadow p-4"
            >
        ...
        {/* Tabs */}
        <div className="inline-flex flex-wrap items-center border border-gray-200 rounded-md bg-white shadow-sm p-1">
          {dataArray.map((tab) => (
            <button
                  ...
                  <div>
                    {
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer mt-1"
                      >
                        View Profile
                      </button>
                    }
